...
namespace CMS.Website.Controllers
{
    ...
    public class UploadController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> SaveProductBrand(IFormFile file) // must match SaveField which defaults to "files"
        {
            if (file != null)
            {
                try
                {
                    ...
                    var fileName = Path.GetFileNameWithoutExtension(fileContent.FileName.ToString().Trim('"')) + Path.GetExtension(fileContent.FileName.ToString().Trim('"'));
                    var pathOriginal = Path.Combine(HostingEnvironment.WebRootPath + $"/data/productbrand/upload/", fileName);
        ...
        [HttpPost]
        public ActionResult RemoveProductBrand(string fileToRemove) // must match RemoveField which defaults to "files"
        {
            if (fileToRemove != null)
            {
                try
