...
namespace CMS.Data.ModelEntity
{
    public partial class CmsContext
    {
        ...
        public virtual CmsContextProcedures Procedures
        {
            get
            {
    ...
    public partial class CmsContextProcedures
    {
        ...
        public virtual async Task<List<SpAccountSearchResult>> SpAccountSearchAsync(string Keyword, Guid? RoleId, int? ProductBrandId, bool? Active, int? PageSize, int? CurrentPage, OutputParameter<int?> ItemCount, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterItemCount = new SqlParameter
            {
                ParameterName = "ItemCount",
                Direction = System.Data.ParameterDirection.InputOutput,
                Value = ItemCount?._value ?? Convert.DBNull,
            ...
            var _ = await _context.SqlQueryAsync<SpAccountSearchResult>("EXEC @returnValue = [dbo].[SpAccountSearch] @Keyword, @RoleId, @ProductBrandId, @Active, @PageSize, @CurrentPage, @ItemCount OUTPUT", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<SpArticleCategoryTreeResult>> SpArticleCategoryTreeAsync(int? Root, string FirstLine, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                ...
                {
                    ParameterName = "Root",
                    Value = Root ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                new SqlParameter
                {
                    ParameterName = "FirstLine",
                    Size = 400,
                    Value = FirstLine ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.NVarChar,
                },
                parameterreturnValue,
            };
            var _ = await _context.SqlQueryAsync<SpArticleCategoryTreeResult>("EXEC @returnValue = [dbo].[SpArticleCategoryTree] @Root, @FirstLine", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<SpGetLstProductPropertiesResult>> SpGetLstProductPropertiesAsync(int? ProductId, int? ProductPropertyCategory, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                ...
                new SqlParameter
                {
                    ParameterName = "ProductPropertyCategory",
                    Value = ProductPropertyCategory ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                parameterreturnValue,
            };
            var _ = await _context.SqlQueryAsync<SpGetLstProductPropertiesResult>("EXEC @returnValue = [dbo].[SpGetLstProductProperties] @ProductId, @ProductPropertyCategory", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<SpLogVisitSearchResult>> SpLogVisitSearchAsync(int? PageSize, int? CurrentPage, OutputParameter<int?> ItemCount, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterItemCount = new SqlParameter
            {
                ParameterName = "ItemCount",
            ...
            var _ = await _context.SqlQueryAsync<SpLogVisitSearchResult>("EXEC @returnValue = [dbo].[SpLogVisitSearch] @PageSize, @CurrentPage, @ItemCount OUTPUT", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<SpProductCategoryTreeResult>> SpProductCategoryTreeAsync(int? Root, string FirstLine, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<SpProductCategoryTreeResult>("EXEC @returnValue = [dbo].[SpProductCategoryTree] @Root, @FirstLine", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<SpProductOrderSearchResult>> SpProductOrderSearchAsync(int? ProductOrderId, string CreateBy, int? ProductOrderStatusId, string OrderBy, int? PageSize, int? CurrentPage, OutputParameter<int?> ItemCount, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterItemCount = new SqlParameter
            {
                ParameterName = "ItemCount",
            ...
            var sqlParameters = new []
            {
                new SqlParameter
                {
                    ParameterName = "ProductOrderId",
                    Value = ProductOrderId ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                new SqlParameter
                {
                ...
                new SqlParameter
                {
                    ParameterName = "ProductOrderStatusId",
                    Value = ProductOrderStatusId ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                new SqlParameter
                {
            ...
            var _ = await _context.SqlQueryAsync<SpProductOrderSearchResult>("EXEC @returnValue = [dbo].[SpProductOrderSearch] @ProductOrderId, @CreateBy, @ProductOrderStatusId, @OrderBy, @PageSize, @CurrentPage, @ItemCount OUTPUT", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<SpProductPropertyCategoryTreeResult>> SpProductPropertyCategoryTreeAsync(int? Root, string FirstLine, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<SpProductPropertyCategoryTreeResult>("EXEC @returnValue = [dbo].[SpProductPropertyCategoryTree] @Root, @FirstLine", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<SpProductReviewSearchResult>> SpProductReviewSearchAsync(string Keyword, int? ProductReviewTypeId, int? LocationId, int? DepartmentManId, int? ProductBrandId, int? ProductId, bool? Active, DateTime? FromDate, DateTime? ToDate, Guid? CreateBy, int? PageSize, int? CurrentPage, OutputParameter<int?> ItemCount, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterItemCount = new SqlParameter
            {
                ParameterName = "ItemCount",
            ...
            var sqlParameters = new []
            {
                ...
                new SqlParameter
                {
                    ParameterName = "ProductReviewTypeId",
                    Value = ProductReviewTypeId ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                new SqlParameter
                {
            ...
            var _ = await _context.SqlQueryAsync<SpProductReviewSearchResult>("EXEC @returnValue = [dbo].[SpProductReviewSearch] @Keyword, @ProductReviewTypeId, @LocationId, @DepartmentManId, @ProductBrandId, @ProductId, @Active, @FromDate, @ToDate, @CreateBy, @PageSize, @CurrentPage, @ItemCount OUTPUT", sqlParameters, cancellationToken);
