...
namespace CMS.Data.ModelEntity
{
    public partial class CmsContext : DbContext
    {
        ...
        public virtual DbSet<AdvertisingType> AdvertisingType { get; set; }
        ...
        public virtual DbSet<ProductBrandAttachFile> ProductBrandAttachFile { get; set; }
        public virtual DbSet<ProductBrandCategory> ProductBrandCategory { get; set; }
        public virtual DbSet<ProductBrandFollow> ProductBrandFollow { get; set; }
        public virtual DbSet<ProductBrandLevel> ProductBrandLevel { get; set; }
        ...
        public virtual DbSet<ProductLogEdit> ProductLogEdit { get; set; }
        ...
        public virtual DbSet<ProductOrderPaymentMethod> ProductOrderPaymentMethod { get; set; }
        public virtual DbSet<ProductOrderPaymentStatus> ProductOrderPaymentStatus { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Advertising>(entity =>
            {
                ...
                entity.Property(e => e.Active).HasComment("Hoạt động hay không");

                entity.Property(e => e.AdvertisingBlockId).HasComment("Khối quảng cáo");

                entity.Property(e => e.AdvertisingTypeId).HasComment("Loại hiển thị: Văn bản, Ảnh, HTML Code");

                entity.Property(e => e.Code).HasComment("HTML Code");

                entity.Property(e => e.Counter).HasComment("Số lần click vào quảng cáo");

                entity.Property(e => e.CreateBy).HasComment("Người tạo");

                entity.Property(e => e.CreateDate).HasComment("Thời gian tạo");

                entity.Property(e => e.Description).HasComment("Chú thích");

                entity.Property(e => e.EndDate).HasComment("Được đăng đến ngày");

                entity.Property(e => e.Height).HasComment("Chiều dọc đối tượng");

                entity.Property(e => e.Image).HasComment("Tên file ảnh");

                entity.Property(e => e.LastEditBy).HasComment("Người chỉnh sửa cuối");

                entity.Property(e => e.LastEditDate).HasComment("Thời gian chỉnh sửa cuối");

                entity.Property(e => e.Name).HasComment("Tên link/banner");

                entity.Property(e => e.Sort).HasComment("Thứ tự sắp xếp");

                entity.Property(e => e.StartDate).HasComment("Được đăng từ ngày");

                entity.Property(e => e.Target).HasComment("Target khi click: _self, _blank");

                entity.Property(e => e.Url).HasComment("Đường dẫn khi click");

                entity.Property(e => e.Width).HasComment("Chiều ngang đối tượng");
            });
            ...
            modelBuilder.Entity<AdvertisingBlock>(entity =>
            {
                ...
                entity.Property(e => e.ArticleCategoryId).HasComment("Chuyên mục tin tức. Trang chủ để NULL");
                ...
                entity.Property(e => e.DeviceDisplay)
                    .HasDefaultValueSql("((0))")
                    .HasComment("Thiết bị hiển thị");

                entity.Property(e => e.LastEditedBy).HasComment("Người chỉnh sửa cuối");

                entity.Property(e => e.LastEditedDate).HasComment("Thời gian chỉnh sửa cuối");

                entity.Property(e => e.Name).HasComment("Tên khối");

                entity.Property(e => e.Sort).HasComment("Thứ tự sắp xếp");
            });

            modelBuilder.Entity<AdvertisingType>(entity =>
            {
                entity.Property(e => e.Id).HasComment("Id tự tăng");

                entity.Property(e => e.Name).HasComment("Loại hiển thị: Văn bản, Ảnh, HTML Code");
            });
            ...
            modelBuilder.Entity<ProductBrand>(entity =>
            {
                ...
                entity.Property(e => e.ViewPageCount).HasDefaultValueSql("((0))");
            });
