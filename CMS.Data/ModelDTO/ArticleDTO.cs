...
namespace CMS.Data.ModelDTO
{
    ...
    public class ArticleLstCategoryDTO
    {
        public ArticleCategory articleCate { get; set; } = new();

        public SpArticleGetTopByCategoryIdResult lstArticleTop { get; set; } = new();
        public List<SpArticleGetNewByCategoryIdResult> lstArticleNew { get; set; } = new();
    }
